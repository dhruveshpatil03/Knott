...
import { CATEGORIES, CONDITIONS, PUNE_AREAS, MIN_LISTING_PRICE, MAX_PRICE_WITHOUT_VERIFICATION } from './CONFIG_constants';
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                onChange={handleInputChange}
                placeholder="12000"
                min={MIN_LISTING_PRICE / 100}
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
              {errors.price && <p className="text-red-600 text-sm mt-1">{errors.price}</p>}
              <p className="text-xs text-gray-500 mt-1">Minimum: ₹{MIN_LISTING_PRICE / 100}</p>
            </div>
