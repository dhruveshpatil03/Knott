...
import { formatDateIST, getTrustScoreColor } from './LIB_utils';
import { Shield, Star, Edit, LogOut, ArrowLeft } from 'lucide-react';
...
export default function PAGES_Profile() {
  ...
  const loadProfile = async () => {
    try {
      ...
      setProfile(data);
      setFormData({ name: data.name, city: data.city, upi_id: data.upi_id });
  ...
  if (!profile) {
    return (
      <div className="text-center py-12">
        ...
        <button onClick={() => navigate('/')} className="text-blue-600 mt-4">Back to home</button>
      </div>
    );
  }

  // BUG FIX: getTrustScoreColor now returns {text, bg} object.
  const trustColor = getTrustScoreColor(profile.trust_score);
        ...
        <div className="max-w-4xl mx-auto px-4 py-6">
          ...
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-1">Joined {formatDateIST(profile.created_at)}</p>
            </div>
            {isOwnProfile && (
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow-md p-6">
              <div className="text-center mb-6 pb-6 border-b border-gray-200">
                ...
                {/* BUG FIX: trustColor.text and trustColor.bg now resolve correctly */}
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="text-center">
                  <p className="text-2xl font-bold text-blue-600">{profile.total_transactions}</p>
                ...
                <div className="space-y-4">
                  {reviews.map(review => (
                    <div key={review.id} className="border-t pt-4 first:border-0 first:pt-0">
                      ...
                      <p className="text-xs text-gray-500 mt-2">{formatDateIST(review.created_at)}</p>
                    </div>
                  ))}
                </div>
              )}
