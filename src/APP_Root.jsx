...
export default function App() {
  const { session, loading, initAuth } = useAuthStore();
  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route
          path="/login"
          element={session ? <Navigate to="/" /> : <PAGES_Login />}
        />
        <Route
          path="/verify"
          element={session ? <Navigate to="/" /> : <PAGES_Verify />}
        />
        <Route
          path="/setup-profile"
          element={
