...
export default function PAGES_Login() {
  ...
  const { signInWithPhone: sendOTP } = useAuthStore();
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-600 to-blue-800 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-12">
          ...
          <p className="text-blue-100 text-lg">Buy &amp; Sell Electronics Safely</p>
        </div>

        <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-xl p-8 space-y-6">
          <h2 className="text-2xl font-bold text-center text-gray-900">Welcome to Knott</h2>
          <p className="text-center text-gray-600">Enter your mobile number to get started</p>
